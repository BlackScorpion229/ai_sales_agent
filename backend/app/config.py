...
class Settings(BaseSettings):
    ...
    cors_origins: str = "http://localhost:5173,http://localhost:3000,http://localhost:3000"
    # Set to True to allow all origins (for development only) - but use with allow_credentials=False
    cors_allow_all_origins: bool = True
    # Note: For production, set this to False and use explicit origins with credentials as needed
